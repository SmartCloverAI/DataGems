const FALLBACK_MAP: Record<string, string[]> = {
  ...
  R1EN_CSTORE_AUTH_BOOTSTRAP_ADMIN_PWD: [
    "EE_CSTORE_AUTH_BOOTSTRAP_ADMIN_PWD",
...
const DEFAULT_MAP: Record<string, string> = {
  ...
  DATAGEN_SMTP_PASS: "",
  DATAGEN_REGISTER_RATE_WINDOW_SECONDS: "900",
  DATAGEN_REGISTER_MAX_PER_IP: "10",
  DATAGEN_REGISTER_MAX_PER_EMAIL: "3",
  DATAGEN_REGISTER_RESEND_WINDOW_SECONDS: "900",
  DATAGEN_REGISTER_RESEND_MAX_PER_IP: "5",
  DATAGEN_REGISTER_RESEND_MAX_PER_EMAIL: "2",
  DATAGEN_REGISTER_FAILURE_TTL_SECONDS: "86400",
};
